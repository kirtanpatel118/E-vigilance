...
<div class="d-flex flex-column flex-root">
    <div id="backimg" class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(<?php echo base_url('assets/media/illustrations/sketchy-1/newp.png');?>)">		
