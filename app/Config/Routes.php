...
$routes->get('update_officer/(:num)', 'Home::update_officer/$1');
$routes->post('update_officer_store', 'Home::update_officer_store');
$routes->post('update_employee', 'Home::update_employee');
$routes->post('delete_employee', 'Home::delete_employee');
$routes->post('delete_officer', 'Home::delete_officer');
$routes->post('delete_complaint', 'Home::delete_complaint');
